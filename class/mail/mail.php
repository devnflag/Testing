<?php
	class Mail{
		...
		function sendMailNewComprobante($ficheroFinal,$tipoComprobante){
			...
			$mail->AddCC('jonathanurbina92@gmail.com', 'Jonathan Urbina');
			if(!$mail->Send()){   
					echo "Error al enviar, causa: " .$mail->ErrorInfo;  
					$ToReturn = false;
			}
		...
		function newComprobanteContentMail($ficheroFinal,$tipoComprobante){
			$ToReturn = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
			"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
		<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
		<head>
			...
			<tr>
				<td align="left">
					<h1 style="font-family: Arial;
						...
						font-weight: normal;line-height: 42px;
						color: #393939;
						margin: 0;mso-line-height-rule: exactly;"><span style="font-size: 42px; line-height: 42px; mso-line-height-rule: exactly;"><strong style="line-height: 42px; font-size: 42px; mso-line-height-rule: exactly;"><span style="line-height: 42px; font-size: 42px; mso-line-height-rule: exactly;">COMPROBANTE DE PAGO</span></strong></span></h1>
				</td>
			</tr>
		</table>
		...
		<p style="color: #393939;
						font-size: 17px;
						font-family: Arial;line-height: 26px;text-align: justify;
						margin: 0;mso-line-height-rule: exactly;">Tipo de Comprobante: '.$tipoComprobante.'<br /></p>
				</td>
			</tr>
		</table>
