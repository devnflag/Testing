...
class DPayPal {
    //API Credentials
    protected $username = "jonur92_api1.gmail.com"; //PayPal API username
    protected $password = "CFNYPP4YKGC2BJXJ"; //PayPal API password
    protected $apiSignature = "AftUST9b90cVq1URFnOhKfNg12l7AW8BqXY9Q4uegUtPNHQ.9vDesnfr"; //PayPal API signature
