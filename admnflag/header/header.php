            ...
            <aside class="sidebar">
                <div class="scrollbar-inner">
                    ...
                    <ul class="navigation">
                        ...
                        <?php
                            $SqlMenuRoot = "select * from menu_admnflag where idPadre='0'";
                            ...
                            foreach($MenuRoot as $Root){
                                $MenuHTML .= "<li class='navigation__sub @@".$Root["Descripcion"]."'>";
                                    ...
                                    $SqlMenuChild = "select * from menu_admnflag where idPadre='".$Root["id"]."'";
                                    $MenuChild = $db->select($SqlMenuChild);
                                    if(count($MenuChild) > 0){
                                        $MenuHTML .= "<ul>";
                                            foreach($MenuChild as $Child){
                                                $MenuHTML .= "<li class='@@".$Child["id"]."'><a href='".$Child["Link"]."'>".$Child["Descripcion"]."</a></li>";
                                            }
                                        $MenuHTML .= "</ul>";
                                    }
                                $MenuHTML .= "</li>";
